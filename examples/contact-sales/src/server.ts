...
import { fixtureResearchHandlers } from "./fixture-research.js";
import { createLeadWorkflow, leadWorkflow, leadWorkflowStart } from "./lead-workflow.js";
import { createDemoAttio } from "./demo-attio.js";
import { updateAttio } from "./update-attio.js";
import { liveAttio, liveTestEnrichment } from "./live-attio.js";
import { fixtureEnrichment } from "./fixture-providers.js";

const publicDirectory = fileURLToPath(new URL("../public", import.meta.url));
const port = Number(process.env.PORT ?? 3000);
const live = process.env.ATTIO_LIVE === "1" ? liveAttio() : null;
const workflowStart = live
        ...
        store.workflows.assignmentStore(
          {
            ...
            routingPolicy: { territories, reps },
          },
          workflowStart,
        ),
        enrichment,
