...
selector.addEventListener('change', () => {
  ...
  if (selector.value === '' || !scenario) { clearForm(); return; }
  ...
  summary.textContent = `Expected: ${scenario.expected.outcome === 'routed' ? 'Cal.com booking' : 'success page'} · ${scenario.expected.route}. You can edit the fields before submitting.`;
});
